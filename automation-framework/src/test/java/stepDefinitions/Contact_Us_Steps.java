...
public class Contact_Us_Steps {
    ...
    public void i_enter_a_unique_first_name() {
        driver.findElement(By.xpath("//form[@id='contact_form']/input[@name='first_name']")).sendKeys("FN - " + generateRandomNumber(3));
    }

    @And("I enter a unique last name")
    public void i_enter_a_unique_last_name() {
        driver.findElement(By.xpath("//form[@id='contact_form']/input[@name='last_name']")).sendKeys("LN - " + generateRandomNumber(5));
    }

    @And("I enter a unique email address")
    public void i_enter_a_unique_email_address() {
        driver.findElement(By.xpath("//form[@id='contact_form']/input[@name='email']")).sendKeys("email" + generateRandomNumber(3) + "@example.com");
    }

    @And("I enter a unique comment")
    public void i_enter_a_unique_comment() {
        driver.findElement(By.xpath("//form[@id='contact_form']/textarea[@name='message']")).sendKeys("message code : " + generateRandomNumber(6));
    ...
    @When("I enter {word} as first name")
    public void i_enter_a_specific_first_name(String name) {
        driver.findElement(By.xpath("//form[@id='contact_form']/input[@name='first_name']")).sendKeys(name);
    }
    ...
    @When("I enter {word} as email address")
    public void i_enter_a_specific_email_address(String email) {
        driver.findElement(By.xpath("//form[@id='contact_form']/input[@name='email']")).sendKeys(email);
    }
    @When("I enter {string} as a comment")
    public void i_enter_a_specific_as_comment(String comment) {
